      ...
      <div className="col-md-5 offset-md-1 mb-3">
        <form>
          ...
          <div className="d-flex flex-column flex-sm-row w-100 gap-2">
            ...
            <input id="newsletter1" type="text" className="form-control" placeholder="Email address" fdprocessedid="jpnf1c" />
            <button className="btn btn-primary" type="button" fdprocessedid="o60o3r">Subscribe</button>
          </div>
        </form>
      </div>
    </div>
